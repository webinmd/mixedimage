...
<ul style="margin-top: -15px">
    ...
    <li><span>pc</span>  - позволяет загружать файл сразу с компьютера пользователя, минуя файловый менеджер MODx</li>
    <li><span>url</span> - позволяет загружать файл по ссылке</li>
    <li><span>crop</span> - позволяет обрезать изображение в модальном окне</li>
</ul>
