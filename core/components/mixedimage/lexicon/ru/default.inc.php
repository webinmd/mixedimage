...
$_lang['mixedimage.crop_suffix_desc'] = 'Если оставить пустым, то файл будет перезаписан. Можно вписать <strong>time()</strong>, для генерации каждый раз нового изображения';
