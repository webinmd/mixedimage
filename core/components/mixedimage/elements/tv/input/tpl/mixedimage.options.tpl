        ...
        {/if}        
            ...
            {/literal}
                ...
                MODx.load({
                    ...
                    {
                        xtype: 'fieldset'
                        , title: _('mixedimage.fieldset.crop')
                        , id: 'mixedimage-fieldset-crop'
                        ...
                        , items: [
                            {
                                ...
                                xtype: 'textfield',
                                fieldLabel: __('mixedimage.crop_options'),
                                id: 'inopt_crop_options{/literal}{$tv}{literal}',
                                anchors: '98%',
                                name: 'inopt_crop_options',
                                value: params['crop_options'] || '',
                                listeners: oc
                            }, {
                                xtype: MODx.expandHelp ? 'label' : 'hidden'
                                , forId: 'inopt_crop_options{/literal}{$tv}{literal}'
                                , html: __('mixedimage.crop_options_desc')
                                , cls: 'desc-under'
                            }
                        ]
                    }, {
